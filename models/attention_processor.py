...
class CogVideoXAttnProcessor2_0:
    ...
    def __call__(
        ...
        # TODO: Change the image_rotary_emb to a tuple ---------------------------------------- #
        image_rotary_emb, attention_kwargs = image_rotary_emb
        # attention_mask = attention_kwargs['attn_mask']
        # ------------------------------------------------------------------------------------ #
        ...
        if image_rotary_emb is not None: 
            ...
            query[:, :, text_seq_length:] = apply_rotary_emb(query[:, :, text_seq_length:], image_rotary_emb, attention_kwargs=attention_kwargs)
            if not attn.is_cross_attention:
                key[:, :, text_seq_length:] = apply_rotary_emb(key[:, :, text_seq_length:], image_rotary_emb, attention_kwargs=attention_kwargs)
